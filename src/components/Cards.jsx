        ...
        <div className='cards'>
            <div className="">          
                ...
                <p className='text-base ml-3 text-gray-400 font-semibold'>ID: 008414 </p>
                    <div class="">        
                        <button onClick={ onHandleClose } type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
